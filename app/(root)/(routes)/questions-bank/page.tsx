  ...
  return (
    <div className='min-h-screen flex flex-col items-center justify-center gap-8 p-4'>
      ...
      <div className='flex flex-wrap justify-center gap-8'>
        ...
        {/* Dictionary Card */}
        <Card className="opacity-50 cursor-not-allowed w-[300px] h-[300px] sm:w-[300px] md:w-[300px] lg:w-[300px] bg-gradient-to-r from-white to-white shadow-lg rounded-xl hover:shadow-2xl transition-all duration-300">
          <CardContent className="flex flex-col items-center justify-center h-full">
            <Image 
              alt='Dictionary'
